...
import { useProviderContext, ChatInput, Disclaimer } from "../../../..";
...
export default function Input(props) {
  var _useGetState = useGetState(''),
    ...
    setContent = _useGetState2[1],
    getContent = _useGetState2[2];
  var prefixCls = useProviderContext().getPrefixCls('chat-anywhere-input');
  var senderOptions = useChatAnywhereOptions(function (v) {
    return v.sender;
  });
  var inputContext = useChatAnywhereInput(function (v) {
    return v;
  });
  var _ref = senderOptions || {},
    _ref$placeholder = _ref.placeholder,
    placeholder = _ref$placeholder === void 0 ? '' : _ref$placeholder,
    _ref$disclaimer = _ref.disclaimer,
    disclaimer = _ref$disclaimer === void 0 ? '' : _ref$disclaimer,
    maxLength = _ref.maxLength,
    _ref$beforeSubmit = _ref.beforeSubmit,
    beforeSubmit = _ref$beforeSubmit === void 0 ? function () {
      return Promise.resolve(true);
    } : _ref$beforeSubmit,
    beforeUI = _ref.beforeUI,
  ...
  var _useAttachments = useAttachments(attachments, {
    ...
    getFileList = _useAttachments.getFileList,
    setFileList = _useAttachments.setFileList,
    handlePasteFile = _useAttachments.handlePasteFile,
  ...
  var handleSubmit = useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          fileList = ((getFileList === null || getFileList === void 0 ? void 0 : getFileList()) || []).filter(function (i) {
            var _i$response;
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      className: "".concat(prefixCls, "-blank")
    })]
  });
}