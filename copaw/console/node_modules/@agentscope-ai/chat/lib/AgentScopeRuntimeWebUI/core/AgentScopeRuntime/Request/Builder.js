...
var AgentScopeRuntimeRequestBuilder = /*#__PURE__*/function () {
  ...
  _createClass(AgentScopeRuntimeRequestBuilder, [{
    ...
    key: "isVideoFile",
    value: function isVideoFile(file) {
    ...
    key: "buildVideoContent",
    value: function buildVideoContent(videoFile) {
      var _videoFile$response;
      return {
        type: AgentScopeRuntimeContentType.VIDEO,
        video_url: (_videoFile$response = videoFile.response) === null || _videoFile$response === void 0 ? void 0 : _videoFile$response.url,
        status: AgentScopeRuntimeRunStatus.Created
      };
    }
  }, {
    key: "buildAudioContent",
    value: function buildAudioContent(audioFile) {
      var _audioFile$response, _audioFile$response2, _audioFile$type;
      return {
        type: AgentScopeRuntimeContentType.AUDIO,
        audio_url: (_audioFile$response = audioFile.response) === null || _audioFile$response === void 0 ? void 0 : _audioFile$response.url,
        data: (_audioFile$response2 = audioFile.response) === null || _audioFile$response2 === void 0 ? void 0 : _audioFile$response2.url,
        format: (_audioFile$type = audioFile.type) === null || _audioFile$type === void 0 ? void 0 : _audioFile$type.replace('audio/', ''),
        status: AgentScopeRuntimeRunStatus.Created
      };
    }
  }, {
    ...
    value: function handle(data) {
      ...
      if ((_data$fileList = data.fileList) !== null && _data$fileList !== void 0 && _data$fileList.length) {
        data.fileList.forEach(function (item) {
          ...
          } else if (_this.isVideoFile(item)) {
            content.push(_this.buildVideoContent(item));
          } else if (_this.isAudioFile(item)) {
            content.push(_this.buildAudioContent(item));
          } else {
