...
export interface IAgentScopeRuntimeWebUIWelcomeOptions {
     ...
     */
    render?: (props: Pick<IAgentScopeRuntimeWebUIWelcomeOptions, 'greeting' | 'description' | 'avatar' | 'prompts'> & {
        onSubmit: (data: {
            query: string;
            fileList?: any[];
        }) => void;
 ...
 */
export interface IAgentScopeRuntimeWebUISenderAttachmentsOptions extends UploadProps {
    /**
     * @description 触发器
...
export interface IAgentScopeRuntimeWebUIInputData {
     ...
     */
    fileList?: (UploadProps['fileList'][number] & {
        file_id?: string;
    })[];
    /**
     * @description 业务参数
