export declare enum AgentScopeRuntimeRunStatus {
    Created = "created",
...
export declare enum AgentScopeRuntimeMessageRole {
    ASSISTANT = "assistant",
    USER = "user",
    SYSTEM = "system"
}
export declare enum AgentScopeRuntimeMessageType {
    MESSAGE = "message",
    REASONING = "reasoning",
...
export declare enum AgentScopeRuntimeContentType {
    TEXT = "text",
    DATA = "data",
    IMAGE = "image",
    AUDIO = "audio",
