...
export function ChatAnywhereInputContextProvider(props) {
  ...
  var getCurrentSessionId = useContextSelector(ChatAnywhereSessionsContext, function (v) {
    return v.getCurrentSessionId;
  });
  var _useGetState = useGetState(false),
    _useGetState2 = _slicedToArray(_useGetState, 3),
    loading = _useGetState2[0],
    _setLoading = _useGetState2[1],
  ...
  var _useGetState3 = useGetState(false),
    ...
    _setDisabled = _useGetState4[1],
    getDisabled = _useGetState4[2];
  var stateMapRef = useRef({});
  var prevSessionIdRef = useRef(undefined);
  var setLoading = useCallback(function (value) {
  ...
  var setDisabled = useCallback(function (value) {
    var sessionId = getCurrentSessionId();
    if (sessionId) {
      if (!stateMapRef.current[sessionId]) {
        stateMapRef.current[sessionId] = {
  ...
  useEffect(function () {
    var _state$loading, _state$disabled;
    ...
    var state = currentSessionId ? stateMapRef.current[currentSessionId] : undefined;
    _setLoading((_state$loading = state === null || state === void 0 ? void 0 : state.loading) !== null && _state$loading !== void 0 ? _state$loading : false);
    _setDisabled((_state$disabled = state === null || state === void 0 ? void 0 : state.disabled) !== null && _state$disabled !== void 0 ? _state$disabled : false);
